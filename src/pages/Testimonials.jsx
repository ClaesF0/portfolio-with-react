...
const Testimonials = ({ currentLanguage }) => {
  ...
  const wordsToHighlightNorwegian = [
    ...
    "samarbeidsvillig",
    "aktiv oppfølging",
    "presise og konstruktive møter",
    "leverte et produkt vi er veldig fornøyde med til avtalt tid",
    "veldig sosial og interessert i sine medmennesker",
    "skjønte fort hva vi ønsket oss ",
    "kjapp til å vise initiativ",
    "lett å samarbeide",
    "ryddig",
    "viktig lagspiller",
    "lett å anbefale",
    ...
    "kreativ, nøyaktig, kvalitetsbevisst",
    "oppmerksom på sine medmennesker",
  ...
  const wordsToHighlight = [
    ...
    "quickly understood our vision",
    "creative",
    "precise",
    "quality-conscious",
    "attentive",
    "high social intelligence",
    "actively contributed advice",
    "suggestions",
    "providing active project follow-up",
    "precise",
    "constructive",
    "delivered a product we are very satisfied with on time",
  ];
